...
// (e.g. "Are you sure you want to delete this resource? [y/N] ").
func confirm(cmd *cobra.Command, message string) (bool, error) { //nolint:unparam // message varies per call site in M1+
